 ...
 */
public class JogoDadosPublic {
    public int[] jogo; // números sorteados
    public int qtVezes; // quantidade de sorteios
    public int min; // valor inicial do intervalo
    public int tam; // tamanho do intervalo
    public long semente; // semente para o gerador de números aleatórios
